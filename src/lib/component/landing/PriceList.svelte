...
{#if showDesignPicker && selectedPackage}
    ...
    >
        <div 
            ...
            class="max-h-[90vh] w-full max-w-4xl overflow-y-auto rounded-[2rem] bg-white p-6 md:p-10 shadow-2xl"
        ...
        >
            <div class="mb-8 flex items-center justify-between border-b border-gray-100 pb-6">
                ...
                <button 
                    onclick={closePicker}
                    class="rounded-full bg-gray-50 p-3 text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition-colors"
                >
                ...
                {#each designs as design (design.id)}
                    ...
                    >
                        <div class="relative aspect-[3/4] overflow-hidden">
                            ...
                            />
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 transition-opacity group-hover:opacity-100 flex items-end justify-center pb-6">
